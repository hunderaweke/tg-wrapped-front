...
import { getChannelAnalytics } from './services/api';
import './App.css';
...
function App() {
  ...
  const handleUsernameSubmit = async (username) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Failed to fetch channel analytics. Try "demo" to see sample data.');
  ...
  return (
    <div className="app">
      ...
      {currentPage === 'loading' && (
        <LoadingPage channelName={channelData?.channel_name || ''} />
      )}
